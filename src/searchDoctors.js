export class DoctorService{
 searchDoctors(location_lat, location_lon, name, condition, pageNumber, perPage){
   return new Promise(function(resolve, reject){
     ...
     let url = `https://api.betterdoctor.com/2016-03-01/doctors?`+ conditionQuery + nameQuery + `location=${location_lat}%2C${location_lon}%2C100&user_location=${location_lat}%2C${location_lon}&skip=${skip}&limit=${perPage}&user_key=${process.env.apiKey}`;
